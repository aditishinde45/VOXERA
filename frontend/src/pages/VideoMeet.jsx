...
import { io } from "socket.io-client"; // ← move here
...
{askUsername === true ?
<> <div> <h2>Enter Your Name:</h2>
<TextField id="outlined-basic" label="Outlined" variant="outlined" value={username} onChange={(e)=>{setUsername(e.target.value)}}/> <Button variant="contained" onClick={connect}>connect</Button>
